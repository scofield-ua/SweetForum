                ...
                <li>
                    <?php
                        if($logged_in) {
                            ...
                            echo $this->Html->link($photo.$user_data['Info']['name'], '/users/profile', array('escape' => false, 'class' => 'profile'));
                        } else {
                            echo $this->Html->link("<strong>+".__d("sweet_forum", "Sign In")."</strong>", '/users/signin?back='.$current_url, array('escape' => false, 'data-toggle' => 'model', 'data-target' => '#signin-modal', 'class' => 'signin'));
                        }
                    ?>
                </li>
            </ul>
            <?php
                echo $this->Form->create('Search', array('type' => 'get', 'url' => '/search', 'class' => 'navbar-form navbar-right', 'role' => 'search'));
